    ...
    <nav class="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-t border-secondary-100 shadow-large">
        <div class="grid grid-cols-4 h-18">
            <a href="{{ route('home') }}" wire:navigate
               class="mobile-nav-item {{ request()->routeIs('home') ? 'mobile-nav-active' : 'mobile-nav-inactive' }}">
            ...
            <a href="{{ route('login') }}" wire:navigate
               class="mobile-nav-item {{ request()->routeIs('login') ? 'mobile-nav-active' : 'mobile-nav-inactive' }}">
                <div class="w-6 h-6 mb-1">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('customer.register') }}" wire:navigate
               class="mobile-nav-item {{ request()->routeIs('customer.register') ? 'mobile-nav-active' : 'mobile-nav-inactive' }}">
                <div class="w-6 h-6 mb-1">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
