                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="w-16">
                            <input type="text" 
                                   ...
                                   maxlength="1"
                                   class="w-full text-center uppercase border border-gray-300 rounded-lg px-2 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('license_plate') border-red-500 @enderror"
                                   placeholder="B"
                        ...
                        <div class="w-24">
                            <input type="text" 
                                   ...
                                   maxlength="4"
                                   class="w-full text-center border border-gray-300 rounded-lg px-2 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('license_plate') border-red-500 @enderror"
                                   placeholder="1234"
                        ...
                        <div class="flex-1 ml-2">
                            ...
                            <span class="font-mono font-bold text-gray-800 ml-1">{{ $plate_area }} {{ $plate_number }} {{ $plate_series }}</span>
                        </div>
                    </div>
                    @error('license_plate')
            ...
            <div class="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="text-sm text-gray-600 space-y-1">
                        <p><span class="font-medium">Denda Keterlambatan:</span> Rp {{ number_format($settings->late_penalty_per_hour ?? 0, 0, ',', '.') }}/jam</p>
                        <p><span class="font-medium">Waktu Jeda:</span> {{ $settings->buffer_time_hours ?? 0 }} jam</p>
                        <p><span class="font-medium">Diskon Member:</span> {{ $settings->member_discount_percentage ?? 0 }}%</p>
                    </div>
                            ...
                            @if($rentalPackages)
                                @foreach($rentalPackages as $package)
                                    <option value="{{ $package->id }}">
                                        {{ $package->name }} ({{ $package->duration_hours }} Jam) - Rp {{ number_format($package->price, 0, ',', '.') }}
                                    </option>
                                @endforeach
                            @endif
                        </select>
