...
<x-public-layout>
    <x-slot name="title">Pusat Bantuan - {{ $settings->company_name ?? 'Anugerah Rentcar' }}</x-slot>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
                ...
                <div class="space-y-3">
                    <a href="tel:{{ $settings->company_phone ?? '+62 897-7777-451' }}" class="block text-accent-600 font-semibold hover:underline">
                        {{ $settings->company_phone ?? '+62 897-7777-451' }}
                    </a>
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp ?? '62897777451') }}" target="_blank" class="inline-flex items-center text-green-600 font-semibold hover:underline">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
                ...
                <a href="mailto:{{ $settings->company_email ?? 'info@anugerahrentcar.com' }}" class="text-accent-600 font-semibold hover:underline">
                    {{ $settings->company_email ?? 'info@anugerahrentcar.com' }}
                </a>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
                ...
                <p class="text-gray-800 font-medium">
                    {{ $settings->company_address ?? 'Blora, Jawa Tengah' }}
                </p>
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mt-8">
                <a href="{{ route('terms') }}#faq" class="text-accent-600 font-medium hover:text-accent-700 hover:underline">
        ...
        <div class="mt-16 bg-primary-50 rounded-xl p-8 text-center border border-primary-100">
            ...
            <a href="{{ route('customer.support') }}" class="inline-block bg-primary-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary-700 transition-colors">
                Buat Tiket Dukungan
            </a>
        </div>
        @endauth
