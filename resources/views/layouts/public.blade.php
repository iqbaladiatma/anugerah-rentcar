                ...
                <div class="flex justify-between items-center h-14 sm:h-16 lg:h-20">
                    ...
                    <div class="hidden lg:flex lg:items-center lg:ml-10 lg:space-x-8">
                        ...
                        @else
                            ...
                            <a href="{{ route('public.support') }}" class="nav-link">
                                Kontak
                            </a>
                        @endauth
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li><a href="{{ route('public.support') }}" class="text-secondary-300 hover:text-accent-500 transition-colors text-base">Hubungi Kami</a></li>
                        </ul>
                    </div>
