                        ...
                        <form method="GET" action="{{ route('vehicles.catalog') }}" class="space-y-6" id="filterForm">
                            ...
                            <div class="space-y-3 pt-4 border-t border-gray-200">
                                ...
                                @if(request()->hasAny(['start_date', 'end_date', 'brand', 'max_price', 'with_driver']))
                                    <a href="{{ route('vehicles.catalog') }}" class="w-full bg-gray-100 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-200 transition-colors text-center block font-medium">
                                        <svg class="w-4 h-4 inline mr-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    @if($vehicles->count() > 0)
                        ...
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="text-sm text-gray-500">
                                {{ $vehicles->count() }} results on this page
                            </div>
                        </div>
