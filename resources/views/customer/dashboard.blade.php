<x-public-layout>
    <div class="bg-white min-h-screen">
        ...
        <div class="container-custom section-padding-sm">
                ...
                <div class="card p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1 min-w-0">
                            ...
                            <p class="text-2xl font-bold text-secondary-900 truncate" title="Rp {{ number_format($stats['total_spent'], 0, ',', '.') }}">
            ...
            @include('customer.partials.payment-alert')
                                                ...
                                                <div>
                                                    ...
                                                    @if($booking->sudahSerahKunci() || $booking->sudahTerimaKunci())
                                                        <div class="flex items-center gap-2 mt-1">
                                                            ...
                                                            @elseif($booking->sudahSerahKunci())
                ...
                <div class="lg:col-span-1">
                    <div class="card p-6">
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="{{ route('vehicles.catalog') }}" class="flex items-center justify-center w-full py-3 px-4 bg-gradient-to-r from-accent-500 to-accent-600 hover:from-accent-600 hover:to-accent-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Pesan Kendaraan Baru
                            </a>
                            <a href="{{ route('customer.bookings') }}" class="flex items-center justify-center w-full py-3 px-4 bg-white border border-secondary-200 hover:bg-secondary-50 text-secondary-700 font-medium rounded-xl transition-colors duration-200">
                                <svg class="w-5 h-5 mr-2 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                </svg>
                                Lihat Pemesanan Saya
                            </a>
                            <a href="{{ route('customer.profile') }}" class="flex items-center justify-center w-full py-3 px-4 bg-white border border-secondary-200 hover:bg-secondary-50 text-secondary-700 font-medium rounded-xl transition-colors duration-200">
                                <svg class="w-5 h-5 mr-2 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                </svg>
                                Edit Profil
                            </a>
                            <a href="{{ route('customer.support') }}" class="flex items-center justify-center w-full py-3 px-4 bg-white border border-secondary-200 hover:bg-secondary-50 text-secondary-700 font-medium rounded-xl transition-colors duration-200">
                                <svg class="w-5 h-5 mr-2 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
