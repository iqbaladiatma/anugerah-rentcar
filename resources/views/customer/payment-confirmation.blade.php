...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
        ...
        <div class="space-y-2 text-sm text-blue-800">
            <p><span class="font-medium">Total Pembayaran:</span> <span class="text-lg font-bold">Rp {{ number_format($booking->total_amount, 0, ',', '.') }}</span></p>
            <p><span class="font-medium">Deposit:</span> <span class="font-semibold">Rp {{ number_format($booking->deposit_amount, 0, ',', '.') }}</span></p>
            <p><span class="font-medium">Metode Pembayaran:</span> {{ $booking->payment_method === 'bank_transfer' ? 'Transfer Bank' : 'Cash' }}</p>
        </div>
            ...
            <label class="flex items-start p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors"
                ...
                <div class="ml-3 flex-1">
                    <div class="flex justify-between items-start">
                        ...
                        <p class="text-xl font-bold text-blue-600">Rp {{ number_format($booking->deposit_amount, 0, ',', '.') }}</p>
                    </div>
                </div>
            </label>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <form id="payment-form" action="{{ route('customer.bookings.payment.submit', $booking) }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
