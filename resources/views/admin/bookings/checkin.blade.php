...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Masuk Kendaraan</h1>
                <p class="text-gray-600 mt-1">Proses pengembalian kendaraan untuk pemesanan {{ $booking->booking_number }}</p>
