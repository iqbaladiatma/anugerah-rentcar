        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Or
                    <a href="<?php echo e(route('customer.login')); ?>" class="font-medium text-blue-600 hover:text-blue-500">
                        sign in to your existing account
                    </a>
                </p>
            </div>
            
            <form class="mt-8 space-y-6" action="<?php echo e(route('customer.register')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input id="name" name="name" type="text" required 
                               ...
                               placeholder="Enter your full name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input id="nik" name="nik" type="text" maxlength="16" required 
                               class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
                               placeholder="Enter your 16-digit NIK" value="<?php echo e(old('nik')); ?>">
