...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Syarat dan Ketentuan - <?php echo e($settings->company_name ?? 'Anugerah Rentcar'); ?> <?php $__env->endSlot(); ?>
    ...
    <section class="bg-gradient-to-r from-accent-600 to-accent-700 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-accent-100 max-w-2xl mx-auto">
                Panduan lengkap untuk menyewa kendaraan di <?php echo e($settings->company_name ?? 'Anugerah Rentcar'); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    Kunjungi halaman <a href="<?php echo e(route('vehicles.catalog')); ?>" class="text-accent-600 hover:underline">Katalog Kendaraan</a>, 
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    Jika Anda pelanggan baru, silakan <a href="<?php echo e(route('customer.register')); ?>" class="text-accent-600 hover:underline">daftar akun</a> terlebih dahulu. 
                                    Jika sudah punya akun, langsung <a href="<?php echo e(route('login')); ?>" class="text-accent-600 hover:underline">masuk</a>.
                                </p>
                            </div>
                        </div>
                ...
                <section class="bg-gradient-to-r from-accent-600 to-accent-700 rounded-xl shadow-lg p-8 text-white">
                    <div class="text-center">
                        ...
                        <div class="flex flex-wrap justify-center gap-4">
                            <a href="tel:<?php echo e($settings->company_phone ?? '+6221123456'); ?>" 
                               class="inline-flex items-center bg-white text-accent-600 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors">
                                ...
                                <?php echo e($settings->company_phone ?? '+62 21 1234 5678'); ?>

                            </a>
                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings->whatsapp ?? '628123456789')); ?>" 
                               target="_blank"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views/pages/terms.blade.php ENDPATH**/ ?>