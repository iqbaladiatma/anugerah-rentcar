<div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">vs <?php echo e($comparison['period2_label'] ?? 'Previous'); ?></p>
    ...
    <div class="bg-white p-6 rounded-lg shadow mb-6">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Monthly Breakdown - <?php echo e($selectedYear); ?></h3>
