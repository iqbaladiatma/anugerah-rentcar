            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-sm text-gray-700">Welcome, <?php echo e(auth()->user()->name); ?></span>
                        <span class="status-badge bg-primary-100 text-primary-800"><?php echo e(ucfirst(auth()->user()->role)); ?></span>
            ...
            <div class="px-4 py-6 sm:px-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-sm text-gray-500 mt-2">You are logged in as: <strong><?php echo e(auth()->user()->role); ?></strong></p>
...
</html><?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views\dashboard.blade.php ENDPATH**/ ?>