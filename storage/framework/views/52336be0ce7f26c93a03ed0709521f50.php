        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <form method="GET" action="<?php echo e(route('admin.reports.profitability')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold text-gray-900"><?php echo e(number_format($reportData['summary']['total_vehicles'])); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold text-green-600"><?php echo e(number_format($reportData['summary']['profitable_vehicles'])); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold <?php echo e($reportData['summary']['total_net_profit'] >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                    Rp <?php echo e(number_format($reportData['summary']['total_net_profit'], 0, ',', '.')); ?>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold text-indigo-600"><?php echo e(number_format($reportData['summary']['average_profit_margin'], 1)); ?>%</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">
                        Analisis Keuntungan Kendaraan (<?php echo e($reportData['period']['start_date']); ?> to <?php echo e($reportData['period']['end_date']); ?>)
                    </h3>
