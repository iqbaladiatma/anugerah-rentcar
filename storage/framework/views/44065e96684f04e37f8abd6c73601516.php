...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Laporan Nilai Hidup Pelanggan')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <form method="GET" action="<?php echo e(route('admin.reports.customer-ltv')); ?>" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="flex items-end space-x-2">
                            <a href="<?php echo e(route('admin.reports.customer-ltv', array_merge(request()->all(), ['format' => 'excel']))); ?>" 
                               class="flex-1 inline-flex justify-center items-center px-3 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Excel
                            </a>
                            <a href="<?php echo e(route('admin.reports.customer-ltv', array_merge(request()->all(), ['format' => 'pdf']))); ?>" 
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-lg font-bold text-gray-900"><?php echo e(number_format($reportData['summary']['total_customers'])); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-lg font-bold text-gray-900">Rp <?php echo e(number_format($reportData['summary']['total_lifetime_value'], 0, ',', '.')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-lg font-bold text-gray-900">Rp <?php echo e(number_format($reportData['summary']['average_lifetime_value'], 0, ',', '.')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-lg font-bold text-gray-900">Rp <?php echo e(number_format($reportData['summary']['top_10_percent_value'], 0, ',', '.')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        Rp <?php echo e(number_format($ltv, 0, ',', '.')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e(number_format($customerData['total_bookings'] ?? 0)); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        Rp <?php echo e(number_format($customerData['average_booking_value'] ?? 0, 0, ',', '.')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($segmentClass); ?>"><?php echo e($segment); ?></span>
                                    </td>
                                </tr>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views/admin/reports/customer-ltv.blade.php ENDPATH**/ ?>