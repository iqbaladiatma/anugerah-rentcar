    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$showSummary): ?>
        ...
        <div class="bg-white rounded-lg shadow-lg">
            ...
            <div class="bg-blue-600 text-white p-6 rounded-t-lg">
                ...
                <p class="text-blue-100 mt-2"><?php echo e($booking->booking_number); ?> - <?php echo e($booking->car->license_plate); ?></p>
            </div>
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium"><?php echo e($booking->start_date->format('d/m/Y H:i')); ?></p>
                        <p class="text-sm text-gray-500">to <?php echo e($booking->end_date->format('d/m/Y H:i')); ?></p>
                    </div>
                    <div>
    ...
    <?php else: ?>
        ...
        <div class="bg-white rounded-lg shadow-lg">
            ...
            <div class="p-6">
                ...
                <!-- Ready Status -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($summary['ready_for_checkout']): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views\livewire\admin\vehicle-checkout-form.blade.php ENDPATH**/ ?>