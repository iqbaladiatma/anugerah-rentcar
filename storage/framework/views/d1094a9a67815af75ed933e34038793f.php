    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <div class="flex justify-between mt-2 text-sm">
                <span class="<?php echo e($currentStep >= 1 ? 'text-blue-600 font-medium' : 'text-gray-500'); ?>">Vehicle Selection</span>
                <span class="<?php echo e($currentStep >= 2 ? 'text-blue-600 font-medium' : 'text-gray-500'); ?>">Pricing Details</span>
                <span class="<?php echo e($currentStep >= 3 ? 'text-blue-600 font-medium' : 'text-gray-500'); ?>">Customer Info</span>
                <span class="<?php echo e($currentStep >= 4 ? 'text-blue-600 font-medium' : 'text-gray-500'); ?>">Documents</span>
                <span class="<?php echo e($currentStep >= 5 ? 'text-blue-600 font-medium' : 'text-gray-500'); ?>">Confirmation</span>
            </div>
        </div>
