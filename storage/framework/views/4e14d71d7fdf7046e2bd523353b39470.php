                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="font-medium"><?php echo e($booking->created_at->format('M d, Y H:i')); ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Payment Status</p>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php if($booking->payment_status === 'paid'): ?> bg-green-100 text-green-800
                                    <?php elseif($booking->payment_status === 'partial'): ?> bg-yellow-100 text-yellow-800
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-2 grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        ...
                                        <p class="font-medium"><?php echo e($booking->car->year); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-gray-500">License Plate</p>
                                        <p class="font-medium"><?php echo e($booking->car->license_plate); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-gray-500">Color</p>
                                        <p class="font-medium"><?php echo e($booking->car->color); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-gray-500">Daily Rate</p>
                                        <p class="font-medium">Rp <?php echo e(number_format($booking->car->daily_rate, 0, ',', '.')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium"><?php echo e($booking->start_date->format('M d, Y H:i')); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">End Date:</span>
                                        <span class="font-medium"><?php echo e($booking->end_date->format('M d, Y H:i')); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($booking->actual_return_date): ?>
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium"><?php echo e($booking->actual_return_date->format('M d, Y H:i')); ?></span>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium"><?php echo e($booking->pickup_location); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">Return:</span>
                                        <span class="font-medium"><?php echo e($booking->return_location); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($booking->notes): ?>
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg p-6">
                            ...
                            <p class="text-gray-700"><?php echo e($booking->notes); ?></p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($booking->late_penalty > 0): ?>
                                <div class="flex justify-between text-red-600">
                                    ...
                                    <span class="font-medium">Rp <?php echo e(number_format($booking->late_penalty, 0, ',', '.')); ?></span>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <hr class="my-3">
                            <div class="flex justify-between text-lg font-semibold">
                                <span>Total Amount:</span>
                                <span>Rp <?php echo e(number_format($booking->total_amount, 0, ',', '.')); ?></span>
                            </div>
