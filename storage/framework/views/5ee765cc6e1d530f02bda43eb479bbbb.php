                    ...
                    <ol class="flex items-center space-x-4">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="<?php echo e(route('vehicles.catalog')); ?>" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">
                                    Vehicles
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-4 text-sm font-medium text-gray-900"><?php echo e($car->brand); ?> <?php echo e($car->model); ?></span>
                            </div>
                        </li>
                    </ol>
                </nav>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($car->weekly_rate && $car->weekly_rate < ($car->daily_rate * 7)): ?>
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">Per Week (Save <?php echo e(number_format(($car->daily_rate * 7) - $car->weekly_rate, 0, ',', '.')); ?>)</p>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($car->driver_fee_per_day > 0): ?>
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <div class="border-t pt-2">
                                        <div class="flex justify-between font-semibold">
                                            ...
                                            <span class="text-blue-600" id="totalDisplay">Rp <?php echo e(number_format($car->daily_rate, 0, ',', '.')); ?></span>
                                        </div>
                                    </div>
                                </div>
