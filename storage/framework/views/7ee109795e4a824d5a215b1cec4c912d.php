    ...
    <div class="bg-white">
        ...
        <div class="bg-blue-600 text-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <h1 class="text-3xl font-bold">Welcome back, <?php echo e(auth('customer')->user()->name); ?>!</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    <!-- Member Status -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth('customer')->user()->is_member): ?>
                        <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-lg p-6 text-white">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-yellow-100"><?php echo e(auth('customer')->user()->getMemberDiscountPercentage()); ?>% discount on all bookings</p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="space-y-3">
                            <a href="<?php echo e(route('vehicles.catalog')); ?>" class="flex items-center p-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50">
                            ...
                            <a href="<?php echo e(route('customer.bookings')); ?>" class="flex items-center p-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50">
                                <svg class="w-5 h-5 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                My Bookings
                            </a>
                            <a href="<?php echo e(route('customer.profile')); ?>" class="flex items-center p-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50">
                                <svg class="w-5 h-5 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
