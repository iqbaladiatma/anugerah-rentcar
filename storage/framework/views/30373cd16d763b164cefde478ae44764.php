...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Laporan Pelanggan')); ?>
                    ...
                    <form method="GET" action="<?php echo e(route('admin.reports.customer')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <select name="member_status" id="member_status" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                <option value="all" <?php echo e(request('member_status') === 'all' ? 'selected' : ''); ?>>Semua Pelanggan</option>
                                <option value="members" <?php echo e(request('member_status') === 'members' ? 'selected' : ''); ?>>Member Hanya</option>
                                <option value="non_members" <?php echo e(request('member_status') === 'non_members' ? 'selected' : ''); ?>>Non-Member Hanya</option>
                            </select>
                        </div>
