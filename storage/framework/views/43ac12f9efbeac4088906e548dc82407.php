        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
                    Edit Vehicle - <?php echo e($car->license_plate); ?>

                </h1>
                <p class="mt-1 text-sm text-gray-500">
                    Update vehicle information, photos, and maintenance details.
                </p>
            </div>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2854060451-0', null);
