<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <!-- Trend Chart -->
        <div class="bg-white p-6 rounded-lg shadow" x-data="trendChart(<?php echo \Illuminate\Support\Js::from($trendData)->toHtml() ?>)">
        ...
        <!-- Category Breakdown -->
        <div class="bg-white p-6 rounded-lg shadow" x-data="categoryChart(<?php echo \Illuminate\Support\Js::from($categoryBreakdown)->toHtml() ?>)">
