    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-xl p-8">
                <form action="<?php echo e(route('customer.complete-profile.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        ...
                        <p class="text-gray-900 font-semibold"><?php echo e($customer->name); ?></p>
                        <p class="text-xs text-gray-500 mt-1">Email: <?php echo e($customer->email); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <input id="phone" name="phone" type="tel" required 
                               ...
                               placeholder="Contoh: 08123456789" value="<?php echo e(old('phone', $customer->phone)); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input id="nik" name="nik" type="text" maxlength="16" required 
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                               placeholder="16 digit NIK sesuai KTP" value="<?php echo e(old('nik', $customer->nik)); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="3" required 
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                                  placeholder="Masukkan alamat lengkap sesuai KTP"><?php echo e(old('address', $customer->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['kk_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views/customer/complete-profile.blade.php ENDPATH**/ ?>