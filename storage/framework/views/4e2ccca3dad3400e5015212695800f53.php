            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600">Booking #<?php echo e($booking->booking_number); ?></p>
                    </div>
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-medium">Rp <?php echo e(number_format($booking->total_amount, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>

                <!-- Modification Form -->
                <form method="POST" action="<?php echo e(route('customer.bookings.update', $booking)); ?>" class="p-6">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="datetime-local" 
                                       name="start_date" 
                                       id="start_date" 
                                       value="<?php echo e(old('start_date', $booking->start_date->format('Y-m-d\TH:i'))); ?>" 
                                       required
                                       min="<?php echo e(now()->addDay()->format('Y-m-d\TH:i')); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" 
                                       name="end_date" 
                                       id="end_date" 
                                       value="<?php echo e(old('end_date', $booking->end_date->format('Y-m-d\TH:i'))); ?>" 
                                       required
                                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       id="pickup_location" 
                                       value="<?php echo e(old('pickup_location', $booking->pickup_location)); ?>" 
                                       required
                                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       id="return_location" 
                                       value="<?php echo e(old('return_location', $booking->return_location)); ?>" 
                                       required
                                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" 
                                           name="with_driver" 
                                           value="1" 
                                           <?php echo e(old('with_driver', $booking->with_driver) ? 'checked' : ''); ?>

                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                    <span class="ml-2 text-sm text-gray-700">Include Driver</span>
                                </label>
                                <p class="mt-1 text-xs text-gray-500">Additional fee: Rp <?php echo e(number_format($booking->car->driver_fee_per_day, 0, ',', '.')); ?>/day</p>
                            </div>
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" 
                                           name="is_out_of_town" 
                                           value="1" 
                                           <?php echo e(old('is_out_of_town', $booking->is_out_of_town) ? 'checked' : ''); ?>
                        ...
                        <!-- Out of Town Fee -->
                        <div id="out_of_town_fee_section" style="display: <?php echo e(old('is_out_of_town', $booking->is_out_of_town) ? 'block' : 'none'); ?>">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" 
                                       ...
                                       id="out_of_town_fee" 
                                       value="<?php echo e(old('out_of_town_fee', $booking->out_of_town_fee)); ?>" 
                                       min="0"
                                       step="1000"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['out_of_town_fee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <textarea name="notes" 
                                      ...
                                      rows="3" 
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Any special requests or notes..."><?php echo e(old('notes', $booking->notes)); ?></textarea>
...
<?php endif; ?><?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views\customer\edit-booking.blade.php ENDPATH**/ ?>