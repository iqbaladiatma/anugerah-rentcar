...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <input 
                    ...
                    wire:model="endDate"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                    min="<?php echo e($startDate ? \Carbon\Carbon::parse($startDate)->addDay()->format('Y-m-d') : date('Y-m-d', strtotime('+1 day'))); ?>"
                >
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($startDate && $endDate): ?>
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p class="text-sm text-blue-700 flex items-center">
                    ...
                    <strong>Duration:</strong> <?php echo e(\Carbon\Carbon::parse($startDate)->diffInDays(\Carbon\Carbon::parse($endDate)) + 1); ?> day(s)
                    • <?php echo e(\Carbon\Carbon::parse($startDate)->format('M d')); ?> - <?php echo e(\Carbon\Carbon::parse($endDate)->format('M d, Y')); ?>
...
</div><?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views\livewire\public\vehicle-search-widget.blade.php ENDPATH**/ ?>