            ...
            <div class="card p-8 lg:p-10 animate-slide-up">
                ...
                <div class="mt-6 text-center space-y-2">
                    <div class="text-sm text-gray-600">
                        ...
                        <a href="<?php echo e(route('customer.register')); ?>" class="font-medium text-accent-600 hover:text-accent-500">
                            Daftar sekarang
                        </a>
                    </div>
                    <div class="text-sm">
...
<?php endif; ?><?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views/auth/unified-login.blade.php ENDPATH**/ ?>