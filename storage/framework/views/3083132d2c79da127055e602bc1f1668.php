            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-xl font-semibold text-gray-900"><?php echo e($customer->name); ?></h2>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3" required
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('address', $customer->address)); ?></textarea>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <button class="text-blue-600 hover:text-blue-500 text-sm font-medium">
                                <?php echo e($customer->ktp_photo ? 'Update KTP' : 'Upload KTP'); ?>
                        ...
                        <div>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <button class="text-blue-600 hover:text-blue-500 text-sm font-medium">
                                <?php echo e($customer->sim_photo ? 'Update SIM' : 'Upload SIM'); ?>
