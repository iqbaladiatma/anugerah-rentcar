        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            ...
            <div class="h-48 bg-gray-200 relative">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vehicle->photo_front): ?>
                    <img 
                        src="<?php echo e(Storage::url($vehicle->photo_front)); ?>" 
            ...
            <div class="p-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a 
                        href="<?php echo e(route('vehicles.show', $vehicle)); ?>" 
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vehicle->weekly_rate): ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vehicles->count() > 0): ?>
    <div class="text-center mt-8">
        <a 
            href="<?php echo e(route('vehicles.catalog')); ?>" 
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH C:\laragon\www\anugerah-rentcar\resources\views\livewire\public\popular-vehicles.blade.php ENDPATH**/ ?>